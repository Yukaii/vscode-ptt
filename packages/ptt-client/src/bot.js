        ...
        return this.enqueue(async () => {
            ...
            while (true) {
                ...
                for (let i = 3; i < 23; i++) {
                    ...
                    const bn = Number.parseInt((0, char_1.substrWidth)('dbcs', line, 3, 4).trim(), 10) || 0;
                    const boardname = (0, char_1.substrWidth)('dbcs', line, 10, 12).trim();
                    const category = (0, char_1.substrWidth)('dbcs', line, 23, 4).trim();
                    let title = (0, char_1.substrWidth)('dbcs', line, 30, 31);
                    let users = (0, char_1.substrWidth)('dbcs', line, 62, 5).trim();
                    let admin = (0, char_1.substrWidth)('dbcs', line, 67).trim();
                    let folder = false;
                    let divider = false;
                    if (boardname === 'MyFavFolder') {
                        title = (0, char_1.substrWidth)('dbcs', line, 30);
                        users = '';
                        admin = '';
                        folder = true;
                    }
                    ...
                    if (!seenKeys.has(itemKey)) {
                        ...
                        favorites.push({
                            bn,
                            read: (0, char_1.substrWidth)('dbcs', line, 8, 2).trim() === '',
                            boardname,
                            category,
                            title: title.trim(),
                            users,
